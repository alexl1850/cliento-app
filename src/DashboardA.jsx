    ...
    <div>
      ...
      {phase === "done" && liveUrl && (
        <div style={{marginBottom:"14px"}}>
          ...
          <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:"12px",overflow:"hidden",marginBottom:"12px"}}>
            <div style={{background:"#F1F3F4",padding:"10px 14px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:"8px"}}>
              ...
              <div style={{flex:1,background:"#fff",borderRadius:"6px",padding:"4px 10px",fontSize:"0.72em",color:C.muted,border:`1px solid ${C.border}`,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontFamily:"monospace"}}>{liveUrl}</div>
              <a href={liveUrl} target="_blank" rel="noopener noreferrer" style={{fontSize:"0.72em",color:C.brand,fontWeight:700,textDecoration:"none",flexShrink:0}}>Open ↗</a>
            </div>
            <iframe src={liveUrl} style={{width:"100%",height:"420px",border:"none",display:"block"}} title="Your live website" loading="lazy" key={liveUrl}/>
          </div>
      ...
      {liveUrl && phase === "ready" && (
        <div style={{marginBottom:"14px"}}>
          <div style={{background:C.greenLt,border:`1.5px solid #BBF7D0`,borderRadius:"12px",padding:"16px",marginBottom:"12px"}}>
            ...
            <div style={{background:"#fff",border:`1px solid #BBF7D0`,borderRadius:"10px",overflow:"hidden",marginBottom:"10px"}}>
              <div style={{background:"#F1F3F4",padding:"8px 12px",borderBottom:`1px solid #BBF7D0`,display:"flex",alignItems:"center",gap:"6px"}}>
                {["#FF5F56","#FFBD2E","#27C93F"].map(c=><div key={c} style={{width:"9px",height:"9px",borderRadius:"50%",background:c}}/>)}
                <div style={{flex:1,fontSize:"0.7em",color:C.muted,fontFamily:"monospace",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{liveUrl}</div>
              </div>
              <iframe src={liveUrl} style={{width:"100%",height:"300px",border:"none",display:"block"}} title="Your live website" loading="lazy"/>
            </div>
            <div style={{display:"flex",gap:"8px"}}>
